...
def get_salary_hh(salary_str: str, salary_list: list) -> tuple:
    #Парсим з/п по критериям минимума и максимума в строке
...
def find_by_salary(collection, minimum: int):
    # Возвращает з/п больше или равной указанной
    rates = get_rate()
    euro_rate = rates['euro']
    usd_rate = rates['dollar']

    statement = {'$gte': minimum}
    statement_dollar = {'$gte': minimum / usd_rate}
    statement_euro = {'$gte': minimum / euro_rate}
